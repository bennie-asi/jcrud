package xyz._990904.Jcrud.manager.util;
...
import xyz._990904.Jcrud.constants.Constants;
...
public class ConfigurationUtil implements ApplicationContextAware {
     ...
     * 新的配置key
     */
    @Value(Constants.JCRUD_TABLE_AUTO_KEY_VALUE)
    private String actableAuto;

    /**
     * 新的配置key
     */
    @Value(Constants.JCRUD_MODEL_PACK_KEY_VALUE)
    private String acmodelPack;

    /**
     * 新的配置key
     */
    @Value(Constants.JCRUD_DATABASE_TYPE_KEY_VALUE)
    ...
    public String getConfig(String key) {
        if (Constants.JCRUD_DATABASE_TYPE_KEY.equals(key) || Constants.DATABASE_TYPE_KEY.equals(key)) {
        ...
        if (Constants.JCRUD_MODEL_PACK_KEY.equals(key) || Constants.MODEL_PACK_KEY.equals(key)) {
        ...
        if (Constants.JCRUD_TABLE_AUTO_KEY.equals(key) || Constants.TABLE_AUTO_KEY.equals(key)) {
        ...
        if (Constants.JCRUD_DATABASE_TYPE_KEY.equals(key) || Constants.DATABASE_TYPE_KEY.equals(key)) {
            ...
            if (null == object) {
                object = properties.get(Constants.JCRUD_DATABASE_TYPE_KEY);
            }
        }
        if (Constants.JCRUD_MODEL_PACK_KEY.equals(key) || Constants.MODEL_PACK_KEY.equals(key)) {
            object = properties.get(Constants.MODEL_PACK_KEY);
            if (null == object) {
                object = properties.get(Constants.JCRUD_MODEL_PACK_KEY);
            }
        }
        if (Constants.JCRUD_TABLE_AUTO_KEY.equals(key) || Constants.TABLE_AUTO_KEY.equals(key)) {
            object = properties.get(Constants.TABLE_AUTO_KEY);
            if (null == object) {
                object = properties.get(Constants.JCRUD_TABLE_AUTO_KEY);
            }
        }
